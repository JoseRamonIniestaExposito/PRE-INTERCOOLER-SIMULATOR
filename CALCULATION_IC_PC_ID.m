function [specific_thrust,overall_eff,C_ts,prop_eff,thermal_eff,Deltak_c,w_s,Tt0,Pt0,pi_fs,Tt2,Pt2,Tt25,Pt25,Tt25_p,Pt25_p,Tt3_prima,Pt3,pi_c,Pt4,alpha_b,Tt5_mix,Pt5,alpha_prima,T9,Pt9,pi_9,V9,V_0] = CALCULATION_IC_PC_ID(M_0,T_0,gamma,r,alpha,P_0,e_i,Tt3_prima_val,Delta_T_Pc_values,eta_cp,e_b,Tt4,bleed,eta_tp,nozzle_velocity_coeff,e_n,e_interp,diff_T,Tt25_p_val,M_2_val,tau_c)
...
Tt25 = tau_c1*Tt2;
Tt3_prima = tau_c1*Tt25_p;

Pt25=(Tt2/Tt25)^(gamma/(1-gamma))*Pt2;
Pt25_p=Pt25;
...
eta_pr = w_f/Deltak_c;
if Tt3_prima_val == 0
    w_s = -(gamma*r)/(gamma-1)*(Tt4-Tt3_prima+T_0-T9+Tt25_p-Tt25+(Tt2-Tt0));
else
    w_s = -(gamma*r)/(gamma-1)*(Tt4-Tt3_prima_val+T_0-T9+Tt25_p-Tt25+(Tt2-Tt0));
end
